...
set xrange [ 100.000 : 450.000 ] noreverse nowriteback
set x2range [ * : * ] noreverse nowriteback
set ylabel "Recall" 
set ylabel  offset character 0, 0, 0 font "" textcolor lt -1 rotate by -270
set y2label "" 
set y2label  offset character 0, 0, 0 font "" textcolor lt -1 rotate by -270
set yrange [ 0.540000 : 0.670000 ] noreverse nowriteback
...
GNUTERM = "wxt"
plot "joined.dat" using 1:2 lt 1 pt 2 ps 2 lw 4 title "LSA" with linespoints, "joined.dat" using 1:3 lt 1 lc rgb "blue" pt 2 ps 2 lw 4 title "LDA" with linespoints, 0.553 lw 4 lc 0 title "Baseline"
#    EOF
