...
set yrange [ 0.600000 : 0.655000 ] noreverse nowriteback
...
GNUTERM = "wxt"
plot "joined.dat" using 1:2 lt 1 pt 2 ps 2 lw 4 title "LSA" with linespoints, "joined.dat" using 1:3 lt 1 lc rgb "blue" pt 2 ps 2 lw 4 title "LDA" with linespoints
#    EOF
