...
Our results are on par with those of many of the entries to the SensEval-3 evaluation exercise. We found LSA at 250 topics (\emph{k = 12}) to perform best (\emph{recall 0.64}), with LSA generally outperforming LDA, and both outperforming HDP.\\
\end{abstract}
